        ...
        <div class='row'>
                ...
                <div class='product__wrapper'>
                    <div class="product__item">
                        <div class='product__img'>
                            <img src="{{asset('public/img/phone1.png')}}">
                        </div>
                        <div class='product__tools'>
                            <div class='product__headline'>
                                <h4>Smart Phone Primo V1</h4>
                            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class='product__wrapper'>
                    <div class="product__item">
                        <div class='product__img'>
                            <img src="{{asset('public/img/phone2.png')}}">
                        </div>
                        <div class='product__tools'>
                            <div class='product__headline'>
                                <h4>Smart Phone Primo V1</h4>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class='product__wrapper'>
                    <div class="product__item">
                        <div class='product__img'>
                            <img src="{{asset('public/img/phone3.png')}}">
                        </div>
                        <div class='product__tools'>
                            <div class='product__headline'>
                                <h4>Smart Phone Primo V1</h4>
        ...
        <div class='row'>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class='product__wrapper'>
                    <div class="product__item">
                        <div class='product__img'>
                            <img src="{{asset('public/img/phone4.png')}}">
                        </div>
                        <div class='product__tools'>
                            <div class='product__headline'>
                                <h4>Smart Phone Primo V1</h4>
                            ...
                            <div class='product__cart__hide'>
                                <div class='product__order'>
                                    ...
                                    <div class='product__cart'>
                                        <a href='#'><i class="far fa-edit"></i> add to wishlist</a>
                                    </div>
                                    <div class='buy__items white'>
                                        <a href="#"><i class="fas fa-arrows-alt-h"></i></a>
                                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class='product__wrapper'>
                    <div class="product__item">
                        <div class='product__img'>
                            <img src="{{asset('public/img/phone6.png')}}">
                        </div>
                        <div class='product__tools'>
                            <div class='product__headline'>
                                <h4>Smart Phone Primo V1</h4>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class='product__wrapper'>
                    <div class="product__item">
                        <div class='product__img'>
                            <img src="{{asset('public/img/phone5.png')}}">
                        </div>
                        <div class='product__tools'>
                            <div class='product__headline'>
                                <h4>Smart Phone Primo V1</h4>
                        ...
                        <div class='product__tools'>
                            ...
                            <div class='product__cart__hide'>
                                <div class='product__order'>
                                    ...
                                    <div class='product__cart'>
                                        <a href='#'><i class="fas fa-arrows-alt-h"></i> add to compare</a>
                                    </div>
                                </div>
                            </div>
                        </div>
